...
pub struct Config {
    ...
    /// Intelligence Pipeline 配置（Phase 2）
    #[serde(default)]
    pub intelligence: Option<IntelligenceConfig>,
}

/// Intelligence Pipeline 配置
#[derive(Debug, Deserialize, Clone)]
#[serde(deny_unknown_fields)]
pub struct IntelligenceConfig {
    ...
    pub enabled: bool,
    /// Debug JSON 输出目录
    #[serde(default = "default_intelligence_debug_dir")]
    pub debug_dir: String,
    /// DecisionHistory 存储路径
    #[serde(default = "default_intelligence_history_path")]
    pub decision_history_path: String,
}

fn default_intelligence_enabled() -> bool {
    false
}
fn default_intelligence_debug_dir() -> String {
    "debug/pipeline".into()
}
fn default_intelligence_history_path() -> String {
    "data/decision_history.jsonl".into()
}
