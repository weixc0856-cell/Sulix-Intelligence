...
//! Signal-candidate generation (`entity_signal_candidates_filtered`) is not yet
//! promoted to the Intelligence context (the unfiltered 3-arg variant was
//! removed as dead/inherent-only).
