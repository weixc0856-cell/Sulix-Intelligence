...
pub struct ArtifactSet {
    ...
    pub refined_domains: std::collections::HashMap<
        String,
        (
            crate::domain::StrategicDomain,
            Vec<crate::domain::StrategicDomain>,
        ),
    >,
...
impl ArtifactSet {
    ...
    pub fn new(
        ...
        refined_domains: std::collections::HashMap<
            String,
            (
                crate::domain::StrategicDomain,
                Vec<crate::domain::StrategicDomain>,
